...
class Usuario(Base):
    ...
    correo_electronico = Column(String(100))  # Agregar columna para el correo electrónico
...
class Proyecto(Base):
    ...
    usuario_id = Column(Integer, ForeignKey('usuarios.id_usuario'))  # Relación con el usuario

    # Relación inversa desde Proyecto a Usuario
...
if __name__ == "__main__":
    ...
    try:
        ...
        nuevo_usuario = Usuario(nombre_usuario="juan.perez", contraseña=hashed_password.decode('utf-8'), rol="administrador", correo_electronico="juan.perez@example.com")
        ...
        nuevo_proyecto = Proyecto(nombre="Desarrollo Web", fecha_inicio=fecha_inicio, fecha_fin=fecha_fin, usuario_id=nuevo_usuario.id_usuario) # Asignar el usuario creador
        ...
        # Asignar el usuario al proyecto (esto podría ser redundante si el creador ya es miembro)
